...
| [Open Source Insights](https://deps.dev)             | Supply chain | `deps.dev/project/github/{owner}%2F{repo}`               | 200, `<title>Open Source Insights</title>`                                                                       |
| [OpenSSF Scorecard](https://scorecard.dev)           | Supply chain | `scorecard.dev/viewer/?uri=github.com/{owner}/{repo}`    | 200, `<title>OpenSSF scorecard report</title>`                                                                   |
