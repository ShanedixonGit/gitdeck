...
| [Git History](https://githistory.xyz)                | Visualise               | `github.githistory.xyz/{owner}/{repo}/blob/{ref}/{file}` | 200. File-scoped: declares `requires: ['ref', 'file']`, so never offered on a folder                             |
